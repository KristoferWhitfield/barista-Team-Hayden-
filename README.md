...
## Main Takeaways
Learned how to manage multiple users on the app. Would love to implement more functionalities to the cashier's screen, like adding a temperature button, or even a "make another order" button that refreshes the page - but will circle back to this. Was able to have the app speak "order for *customer's name* is ready, so that was really fun to learn! 